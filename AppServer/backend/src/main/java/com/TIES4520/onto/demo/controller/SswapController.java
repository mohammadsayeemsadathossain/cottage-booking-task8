...
import com.TIES4520.onto.demo.service.SswapService;

@RestController
@RequestMapping("/CottageService")
public class SswapController {

    @Autowired
    private ResourceLoader resourceLoader;
    
    @Autowired
    private SswapService sswapService;
    ...
    public ResponseEntity<String> getServiceDescription() throws IOException {
        ...
        Resource resource = resourceLoader.getResource("classpath:SearchCottage_RDG.txt");
    ...
    public ResponseEntity<String> executeSearch(
        ...
        try {
            ...
            String rigTurtleContent = sswapService.executeSearchService(rrgTurtleContent);
