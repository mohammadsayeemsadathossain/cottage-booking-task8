...
import com.TIES4520.onto.demo.service.SswapServiceG06;

@RestController
@RequestMapping("/CottageService/g06")
public class SswapControllerG06 {

    @Autowired
    private ResourceLoader resourceLoader;
    
    @Autowired
    private SswapServiceG06 sswapService;
    ...
    public ResponseEntity<String> getServiceDescription() throws IOException {
        ...
        Resource resource = resourceLoader.getResource("classpath:g06_rdg.ttl");
    ...
    public ResponseEntity<String> executeSearch(
        ...
        try {
            ...
            String rigTurtleContent = sswapService.executeCottageBookingService(rrgTurtleContent);
